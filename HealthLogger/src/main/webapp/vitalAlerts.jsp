...
<body>
	...
	while (result.next()) {
		...
		if( !(result.getInt("bpLow") < 50 || result.getInt("bpHigh") > 160 || result.getInt("spo2") < 90)) {
			continue;
		}
	...
	<div
		...
		<h1 style="color: red">Vital Alerts</h1>
		<br>
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<%
						int threshold = (int)vital.get("bpLow");
						if(threshold < 50){
					%>
						<td style="color: red;"><b><%=vital.get("bpLow")%></b></td>
					<%	
						}else{
					%>
					...
					<%
						threshold = (int)vital.get("bpHigh");
						if(threshold > 160){
					%>
						<td style="color: red;"><b><%=vital.get("bpHigh")%></b></td>
					<%	
						}else{
					%>
					...
					<%
						threshold = (int)vital.get("spo2");
						if(threshold < 90){
					%>
						<td style="color: red;"><b><%=vital.get("spo2")%></b></td>
					<%	
						}else{
					%>
